...
## Формула бленда
$\hat{x}_0 = M \odot x_0^{\text{SR}} + (1 - M) \odot x_0^{\text{LQ}}$, где $M$ — маска (1 \u2014 улучшать), $x_0^{\text{SR}}$ \u2014 предсказанный латент, $x_0^{\text{LQ}}$ \u2014 латент исходного LQ (или HR, если берём эталон). Маска и HR приводятся к размеру латента.
